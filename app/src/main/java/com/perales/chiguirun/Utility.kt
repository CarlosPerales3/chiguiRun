...
import com.perales.chiguirun.MainActivity.Companion.activatedGPS
import com.perales.chiguirun.MainActivity.Companion.totalsRunning
import com.perales.chiguirun.MainActivity.Companion.totalsSelectedSport
...
object Utility {
    ...
    private fun deleteRun(idRun: String, sport: String, ly: LinearLayout){
        ...
        dbRun.collection("runsRunning").document(idRun)
            .delete()
